...
\begin{proof}
Sei $d_{n} = kgV{1 \leq m \leq n}{\{m\}}$, zuerst wird  gezeigt, dass $m {n \choose m} \mid d_n$.\newline 
...
% \begin{proof}
% Dieses Resultat wird durch Analyse der einzelnen Schritte des Algorithmus festgestellt. Im ersten Schritt wird überprüft, ob eine eine Potenz von einer anderen Zahl ist, dies kann durch den folgenden effizienten Algorithmus berechnet:
