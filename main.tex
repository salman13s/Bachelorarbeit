...
Abbildung \ref{runtime-find_r} zeigt, dass das gewählte Polynom vom Grad 7 (rot in der Grafik) die Funktion der Mittelwerte von den Inputgrößen(bl) nahezu zu perfekt darstellt.
