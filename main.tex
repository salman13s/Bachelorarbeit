...
Dies lässt sich am besten mit einer Grafik illustrieren:
\begin{figure}[h]
...
in diesem Schritt werden $l = \lfloor \sqrt{\phi(n)} log \, n \rfloor$ Gleichungen überprüft. In jeder Gleichung wird $(X + a)^n \, mod \, (X^r - 1,n)$ berechnet. Dies kann   
